...
def quantize_and_insert_k_kernel(
    ...
    for qblock_idx in tl.static_range(n_quant_blocks):
        ...
        if qblock_start < fp8_dim:
            ...
            # Encode FP8 as raw bytes. Pre-SM89 CUDA uses the software E4M3FN
            # conversion because Triton cannot emit a native cast there.
    ...
    for i in range(worker_id, gather_len, num_workers):
        ...
        for qblock_idx in tl.static_range(n_quant_blocks):
            ...
            if qblock_start < fp8_dim:
                ...
                # Decode FP8 bytes to float32; the software path is selected
                # automatically on pre-SM89 CUDA.
