...
class DeepseekCompressor(nn.Module):
    ...
    def forward(
        ...
        if is_cutedsl_supported() and self.head_dim == 512:
            ...
            # head=512 on SM90+ CUDA uses cutedsl for both the fp8_ds_mla
            # layout and the plain full-cache layout. Pre-Hopper CUDA takes
            # the Triton path below like AMD and XPU.
