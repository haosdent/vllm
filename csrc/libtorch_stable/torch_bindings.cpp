...
STABLE_TORCH_LIBRARY_FRAGMENT(_C, ops) {
  ...
  ops.def(
      "persistent_topk_global(Tensor logits, Tensor lengths, Tensor! output, Tensor! valid_count, Tensor block_table, Tensor req_id, int k, int block_size, int num_pool_blocks) -> ()");
